...
# Definice období listopadu 2024
...
for _ in range(num_rows):
    ...
    # Náhodné datum v listopadu 2024
...
# Uložení DataFrame do Excel souboru s názvem fact_prodej.xlsx
excel_filename = "fact_prodej.xlsx"
